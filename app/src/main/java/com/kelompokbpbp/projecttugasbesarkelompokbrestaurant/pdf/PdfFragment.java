...
public class PdfFragment extends Fragment {
    ...
    public void loadDaftarTransaksi(){
        setAdapter();
        getTransaksi();
    }

    public void setAdapter(){
        getActivity().setTitle("Data Transaksi");
        listTransaksi = new ArrayList<Transaksi>();
        recyclerView = root.findViewById(R.id.rvTransaksis);
        adapter = new TransaksiAdapter(root.getContext(), listTransaksi);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCetak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Apakah anda yakin ingin mencetak daftar transaksi ?");
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        String pdfname = "Daftar Transaksi"+".pdf";
        ...
        Paragraph judul = new Paragraph(" Daftar Transaksi Restoku \n\n", new
        ...
        Paragraph Pembuka = new Paragraph("\nBerikut merupakan daftar transaksi Restoku : \n\n",f);
        Pembuka.setIndentationLeft(20);
        document.add(Pembuka);
        PdfPTable tableHeader = new PdfPTable(new float[]{5,3,3});
        ...
        PdfPCell h2 = new PdfPCell(new Phrase("Total Harga"));
        h2.setHorizontalAlignment(Element.ALIGN_CENTER);
        h2.setPaddingBottom(5);
        PdfPCell h4 = new PdfPCell(new Phrase("Status"));
        ...
        PdfPTable tableData = new PdfPTable(new float[]{5,3,3});
    ...
    public void getTransaksi() {
        ...
        final JsonObjectRequest stringRequest = new JsonObjectRequest(GET, "https://pbp.dbappz.top/api/transaction"
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Transaksi transaksi = new Transaksi(id,customerName,totalPrice,status);
